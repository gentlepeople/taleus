...
CREATE TABLE users (
    ...
    couple_start_date TIMESTAMP NULL,
...
CREATE TABLE couple (
    couple_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE mission (
    mission_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE couple_mission (
    couple_mission_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE mission_reminder (
    mission_reminder_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    couple_mission_id BIGINT NOT NULL,
    sender_id VARCHAR NOT NULL,
    receiver_id VARCHAR NOT NULL,
    reminder_time TIMESTAMPTZ DEFAULT NOW() NOT NULL,
    created_at TIMESTAMPTZ DEFAULT NOW() NOT NULL,
    updated_at TIMESTAMPTZ DEFAULT NOW() NOT NULL,
    PRIMARY KEY (mission_reminder_id),
...
CREATE TRIGGER mission_reminder_set_updated_at
BEFORE UPDATE ON mission_reminder FOR EACH ROW
EXECUTE PROCEDURE trigger_set_updated_at();


CREATE TABLE response (
    response_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    couple_mission_id BIGINT NULL,
    user_id VARCHAR NOT NULL,
